    ...
    >
        ...
        <form action="/" method="POST" class="search-form">
            <div class="input-label-field">
                ...
                <input type="number" name="pin" id="pin" required min="1000" max="9999" class="input">
            </div>
            <h5><?= (isset($_POST['pin']) && $auth === null ? 'There\'s no such user..' : '') ?></h5>
            <div class="button">
...
<div class="user-page">
    ...
    <div class="">
        ...
        <form action="/" method="POST">
            <div class="message-form">
                <label for="message" class="input">Your Message</label>
    ...
    <div class="message-timeline">
        <h3><?= (count($messages) > 0 ? 'Your Messages' : 'No messages yet... Create one!')?></h3>
